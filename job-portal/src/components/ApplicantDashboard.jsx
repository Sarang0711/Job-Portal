...
function ApplicantDashboard(props) {
  ...
  const { applied, handleApplied } = useContext(LoginContext);
  console.log("Login user", applied.name, applied.username);
  console.log("appliedajf", props.applied);
      ...
      <Navbar bg="light" className="custom-nav">
        ...
        <NavbarCollapse id="basic-navbar-nav">
          <Nav className="mx-auto">
            <NavLink exact="true" path="/dashboard" className="nav-link">
              New Jobs
            </NavLink>
            <NavLink path="/applied" className="nav-link">
              Applied
            </NavLink>
            <NavLink path="/referfriend" className="nav-link">
              Refer a Friend
            </NavLink>
            <NavLink path="/messages" className="nav-link">
              Messages
            </NavLink>
